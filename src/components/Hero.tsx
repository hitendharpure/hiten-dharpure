    ...
    <section className="grid grid-cols-1 md:grid-cols-2 shrink-0 gap-6 pt-12 md:pt-0 lg:h-[400px]" id="about">
      ...
      <div className="flex flex-col justify-center gap-4 md:pl-4">
        ...
        <p className="text-gray-400 text-sm max-w-sm mt-2 md:mt-0 leading-relaxed">
          Guinness World Record-holding innovator and developer specializing in robotics, AI, and hardware engineering. From engineering the world's smallest AI weather station to building accessible applications like HastaVaani, I focus on pushing the boundaries of what is possible with code and precision hardware.
        </p>
      </div>
